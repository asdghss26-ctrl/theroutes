...
export default function MobileFloatingCTA() {
  return (
    ...
    >
      <a
        href={`https://wa.me/91${ENQUIRY_NUMBER}`}
        target="_blank"
        rel="noopener noreferrer"
        id="mobile-whatsapp-cta"
        className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold text-sm py-4 hover:bg-[#128C48] transition-colors"
      ...
      <a
        ...
        id="mobile-call-cta"
        className="flex-1 flex items-center justify-center gap-2 bg-navy text-white font-semibold text-sm py-4 hover:bg-navy/80 transition-colors"
        aria-label="Call Us"
      >
        <svg
          width="18"
